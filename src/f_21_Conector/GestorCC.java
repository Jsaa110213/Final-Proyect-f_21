...
public class GestorCC extends ModeloCC {
    ...
    public void crear() {
        ...
        System.out.print("Ingrese el ID del cuatrimetre que deseas asignar: ");
        int idCuatri = scanner.nextInt(); // Leer el ID del Cuatrimestre
        Crear(idCiclo, idCuatri); // Llamar al método para crear un nuevo registro
    ...
    public void leer() {
        System.out.print("Ingrese el ciclo_cuatri que deseas consultar: ");
        int id = scanner.nextInt(); // Leer el ID del registro
        CC cc = Leer(id); // Obtener el registro

        // Formato de tabla para el registro
        ...
        if (cc != null) {
            ...
            System.out.println("| N/A | N/A    | N/A         |"); // Mostrar un mensaje cuando el registro no se
                                                                  // encuentra
        }
    ...
    public void actualizar() {
        ...
        if (cc != null) {
            ...
            System.out.print("Ingreseo el nuevo ID de ciclo_cuatri (dejar en blanco para no realizar cambios): ");
