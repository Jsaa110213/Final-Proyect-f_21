...
public class GestorCuatri extends ModeloCuatri {
    ...
    public void listar() {
        listarCuatrimestres(); // Llamar al método de la clase ModeloCuatri para listar cuatrimestres
        // Imprimir los cuatrimestres en formato de tabla
        System.out.println("+----+--------------+");
        System.out.println("| ID | Cuatrimestre |");
        System.out.println("+----+--------------+");
        for (Cuatrimestre cuatrimestre : getCarteraCuatrimestre()) {
    ...
    public void leer() {
        ...
        int id;
        try {
            id = scanner.nextInt(); // Leer el ID del cuatrimestre
            scanner.nextLine(); // Limpiar el buffer del Scanner
    ...
    public void actualizar() {
        ...
        int idActual;
        try {
            idActual = scanner.nextInt(); // Leer el ID actual del cuatrimestre
            scanner.nextLine(); // Limpiar el buffer del Scanner
    ...
    public static class Main {
        public static void main(String[] args) {
            GestorCuatri gestor = new GestorCuatri(); // Crear una instancia de GestorCuatrimestres
